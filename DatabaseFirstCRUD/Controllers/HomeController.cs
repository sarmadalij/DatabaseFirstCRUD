...
namespace DatabaseFirstCRUD.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Designation,Salary")] Employee employee)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                TempData["update_success"] = employee.Name + "'s Data Updated Successfully";
                return RedirectToAction(nameof(Index));
            }
            return View(employee);
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            await _context.SaveChangesAsync();
            TempData["delete_success"] = "ID No. "+ id + "'s Data Deleted Successfully";
            return RedirectToAction(nameof(Index));
        }
